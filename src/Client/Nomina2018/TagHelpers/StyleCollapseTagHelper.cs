...
namespace Nomina2018.TagHelpers
{
    [HtmlTargetElement(Attributes = "is-style-collapse-route")]
    public class StyleCollapseTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.Attributes.RemoveAll("is-style-collapse-route");
        }
        ...
        private void MakeActive(TagHelperOutput output)
        {
            var styleAttr = output.Attributes.FirstOrDefault(a => a.Name == "style");
             ...
             if (styleAttr.Value.ToString() == "height: 7.04px;")
            {
